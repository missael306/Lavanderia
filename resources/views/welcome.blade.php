...
<body data-spy="scroll" data-target="#bs-example-navbar-collapse-1" data-offset="90">
		...
		<div id="main_slider_ten" class="rev_slider" data-version="5.3.1.6">
			<ul>
				<li data-index="rs-2972" data-transition="slidingoverlayhorizontal" data-slotamount="default"
					...
					data-masterspeed="default" data-thumb="{{asset('plugins/plantilla/img/home-slider/slider-1.jpg')}}" data-rotate="0"
					data-saveperformance="off" data-title="Web Show" data-param1="" data-param2="" data-param3=""
					data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9=""
					data-param10="" data-description="">
					<!-- MAIN IMAGE -->
					<!-- LAYERS -->
					<div class="slider_text_box">
						<div class="tp-caption first_text" data-x="['right','right','center','center']"
							data-y="['middle','middle','middle','middle']" data-hoffset="['20','20','0','0']"
							data-voffset="['-100','-100','-100','-100']" data-fontsize="['20','20','20','20','20']"
							data-lineheight="['30','30','30','30','30']"
							data-width="['none','none','none','100%','100%']" data-height="none"
						...
						<div class="tp-caption secand_text" data-x="['right','right','center','center']"
							...
							data-voffset="['-10','0','0','0','-20']" data-fontsize="['60','40','40','40','30']"
							...
							This Apps Free <br />For Commercial Use</div>
						<div class="tp-caption third_text" data-x="['right','right','center','center','center']"
							data-y="middle" data-hoffset="['20','0','0','0']"
							data-voffset="['120','120','120','120','105']" data-fontsize="['16','16','28','28']"
							...
							data-elementdelay="0.05" data-textAlign="['right','right','center','center']">
						...
						<div class="tp-caption tp-resizeme rs-parallaxlevel-2 ten_mobile"
							data-x="['-50','-50','-50','-50']" data-hoffset="['0','0','0','0']"
							...
							data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
							style="z-index: 5;"><img src="{{asset('plugins/plantilla/img/home-slider/airpod.png')}}" alt="" data-no-retina>
						</div>
					</div>
				</li>
	...
	<section class="ten_registration">
		<div class="container">
			<div class="pull-left">
				<h4>If you want to download this apps first need to registration!</h4>
			</div>
	...
	<section class="ten_powerfull_area p_100" id="about">
		<div class="container">
			<div class="ten_title">
				<h2><span>About</span> Our Powerful Apps</h2>
			...
			<div class="ten_perfomance">
				<div class="row">
					<div class="col-md-6">
						<div class="ten_p_img">
							<img src="{{asset('plugins/plantilla/img/ten-mobile.png')}}" alt="">
						</div>
					</div>
					<div class="col-md-6">
						<div class="ten_p_text">
							<h3>This app have a option for performance checking.</h3>
				...
				<div class="row">
						...
						<div class="media">
							<div class="media-left">
								<div class="ten_d_icon">
									<img src="{{asset('plugins/plantilla/img/icon/ten-d-1.png')}}" alt="">
								</div>
							</div>
					...
					<div class="col-md-4">
						<div class="media">
							<div class="media-left">
								<div class="ten_d_icon">
									<img src="{{asset('plugins/plantilla/img/icon/ten-d-2.png')}}" alt="">
								</div>
							</div>
							<div class="media-body">
								<h4>Multitouch Option</h4>
					...
					<div class="col-md-4">
						<div class="media">
							<div class="media-left">
								<div class="ten_d_icon">
									<img src="{{asset('plugins/plantilla/img/icon/ten-d-3.png')}}" alt="">
								</div>
							</div>
							<div class="media-body">
								<h4>Multitouch Option</h4>
					...
					<div class="col-md-4">
						<div class="media">
							<div class="media-left">
								<div class="ten_d_icon">
									<img src="{{asset('plugins/plantilla/img/icon/ten-d-4.png')}}" alt="">
								</div>
							</div>
							<div class="media-body">
								<h4>Multitouch Option</h4>
					...
					<div class="col-md-4">
						<div class="media">
							<div class="media-left">
								<div class="ten_d_icon">
									<img src="{{asset('plugins/plantilla/img/icon/ten-d-5.png')}}" alt="">
								</div>
							</div>
							<div class="media-body">
								<h4>Multitouch Option</h4>
					...
					<div class="col-md-4">
						<div class="media">
							<div class="media-left">
								<div class="ten_d_icon">
									<img src="{{asset('plugins/plantilla/img/icon/ten-d-6.png')}}" alt="">
								</div>
							</div>
							<div class="media-body">
								<h4>Multitouch Option</h4>
	...
	<section class="ten_screen_area" id="screenshot">
		<div class="container">
			<div class="ten_d_text">
				<h2>Apps <span>Screenshots</span> Pixel View</h2>
				<p>There are many variations of passages of Lorem Ipsum available.</p>
			</div>
			<div class="flip_ten_slider">
				<ul class="flip-items">
					<li data-flip-title="Red">
						<img src="{{asset('plugins/plantilla/img/3d-slider/flip-1.jpg')}}" alt="">
					</li>
					<li data-flip-title="Red">
						<img src="{{asset('plugins/plantilla/img/3d-slider/flip-2.jpg')}}" alt="">
					</li>
					<li data-flip-title="Red">
						<img src="{{asset('plugins/plantilla/img/3d-slider/flip-3.jpg')}}" alt="">
					</li>
					<li data-flip-title="Red">
						<img src="{{asset('plugins/plantilla/img/3d-slider/flip-1.jpg')}}" alt="">
					</li>
		...
		<div class="left_ten">
			<div class="ten_video_text">
				<div class="text_v_text_inner">
					<h4>Review With Our Video Tutorial</h4>
					<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered
						alteration in some form, by injected humour, or randomised words which don't look even slightly
						believable.</p>
					<a class="popup-youtube" href="https://www.youtube.com/watch?v=WVPRkcczXCY">Watch Video</a>
				</div>
			</div>
		</div>
		<div class="right_ten">
			<div class="ten_video_img">
				<img src="{{asset('plugins/plantilla/img/video/ten-video.jpg')}}" alt="">
				<a class="popup-youtube ten_video_icon" href="https://www.youtube.com/watch?v=WVPRkcczXCY"><img src="{{asset('plugins/plantilla/img/video/ten-video-icon.png')}}" alt=""></a>
			</div>
		</div>
	</section>
	<!--================End Ten Video Area =================-->
	...
	<section class="ten_team_area p_100" id="team">
		<div class="container">
			<div class="ten_title">
				<h2>Introduce With<span>Team</span> Member</h2>
				<p>There are many variations of passages of Lorem Ipsum available.</p>
			</div>
			<div class="ten_team_slider owl-carousel">
				<div class="item">
					<div class="ten_team_item">
						<img src="{{asset('plugins/plantilla/img/team-slider/ten-team-1.jpg')}}" alt="">
						<h4>Helina Rume</h4>
						<p>Web Designer</p>
				...
				<div class="item">
					<div class="ten_team_item">
						<img src="{{asset('plugins/plantilla/img/team-slider/ten-team-2.jpg')}}" alt="">
						<h4>Helina Rume</h4>
						<p>Web Designer</p>
						<div class="ten_team_hover">
							<div class="ten_team_h_inner">
				...
				<div class="item">
					<div class="ten_team_item">
						<img src="{{asset('plugins/plantilla/img/team-slider/ten-team-3.jpg')}}" alt="">
						<h4>Lumaya Lifa</h4>
						<p>UI/Ux Expert</p>
						<div class="ten_team_hover">
							<div class="ten_team_h_inner">
	...
	<!--================Ten Newsletter Area =================-->
	<section class="ten_newsletter_area">
		<div class="container">
			<div class="row newsletter_inner">
				<div class="col-md-6">
					<div class="left_ns_text">
						<h3>This Apps Available For All Device</h3>
						<a href="#">Iphone,</a>
						<a href="#">Android,</a>
						<a href="#">Imac,</a>
						<a href="#">Macbook,</a>
						...
						<div class="store_link">
							<a href="#"><img src="{{asset('plugins/plantilla/img/icon/apple.jpg')}}" alt=""></a>
							<a href="#"><img src="{{asset('plugins/plantilla/img/icon/google.jpg')}}" alt=""></a>
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="right_ns_text">
						<h3>Subscribe Our <span>Newsletter</span> For Save Your Time</h3>
						<p>It is a long established fact that a reader will be distracted.</p>
						<div class="input-group">
							<input type="text" class="form-control" placeholder="Type email">
							<span class="input-group-btn">
								<button class="btn btn-default" type="button"><i
										class="icofont icofont-envelope-open"></i></button>
							</span>
						</div>
					</div>
				</div>
	...
	<section class="ten_say_area p_100">
		<div class="container">
			...
			<div class="ten_say_slider owl-carousel">
				<div class="item">
					<div class="ten_say_item">
						<div class="media">
							<div class="media-left">
								<img src="{{asset('plugins/plantilla/img/testimonials/ten-testi-1.png')}}" alt="">
							</div>
							<div class="media-body">
								<h4>Jon Smith</h4>
								<h5>CEO of linga Lmt.</h5>
							</div>
						</div>
				...
				<div class="item">
					<div class="ten_say_item">
						<div class="media">
							<div class="media-left">
								<img src="{{asset('plugins/plantilla/img/testimonials/ten-testi-2.png')}}" alt="">
							</div>
							<div class="media-body">
								<h4>Jon Deo</h4>
								<h5>CEO of linga Lmt.</h5>
	...
	<section class="ten_price_area p_100" id="price">
		<div class="container">
			<div class="row ten_price_list_inner">
				...
				<div class="col-md-4 col-xs-6">
					<div class="ten_price_item green">
						<div class="ten_price_item_box">
							<div class="ten_p_head">
								<h3>Gold Plan</h3>
	...
	<section class="ten_question_area">
		<div class="container">
			<div class="ten_title">
				<h2>Four Important <span>Question</span> On Drimo Apps</h2>
				<p>It is a long established fact that a reader will be distracted by the readable content of a page when
					looking <br />at its layout.</p>
			</div>
						...
						<div class="panel-heading" role="tab" id="headingOne">
							<h4 class="panel-title">
								<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne"
									...
									What is a long established fact that a reader will be distracted?
